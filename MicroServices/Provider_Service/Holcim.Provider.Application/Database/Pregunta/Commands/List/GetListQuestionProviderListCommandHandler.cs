...
{
    public class GetListQuestionProviderListCommandHandler : IGetListQuestionProviderListCommandHandler
    {
        private readonly IDapperProcedure _dapperProcedure;

        public GetListQuestionProviderListCommandHandler(IDapperProcedure dapperProcedure)
        {

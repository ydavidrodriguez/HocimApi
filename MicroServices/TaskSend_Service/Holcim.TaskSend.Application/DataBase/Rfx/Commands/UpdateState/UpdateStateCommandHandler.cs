...
namespace Holcim.TaskSend.Application.DataBase.Rfx.Commands.UpdateState
{
    public class UpdateStateCommandHandler : BackgroundService
    {
        ...
        public UpdateStateCommandHandler(IDapperProcedure dapperProcedure, IMapper mapper, ICreateCorreoCommandHandler createCorreoCommandHandler)
        {
